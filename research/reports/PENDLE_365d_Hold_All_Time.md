...
**完整數據範圍**: 2021-04-29 至 2026-09-09
**分析進場區間**: 2021-04-29 至 2025-09-08

## 統計概覽 (Statistics Overview)
| 指標 | 數值 | 說明 |
| :--- | :--- | :--- |
| **總交易樣本數** | 1594 天 | 模擬在此區間內每天買入 |
| **勝率 (Win Rate)** | **51.07%** (814 天) | 持有 365 天後獲利的機率 |
| **賠率 (Loss Rate)** | 48.93% (780 天) | 持有 365 天後虧損的機率 |
...
| **虧損交易平均回報** | -62.80% | -63.97% |
| **盈虧比 (Reward/Risk)** | **13.95** | **9.74** |

## 情景分析 (Scenario Analysis - Based on Quartiles)
| 情景 (Scenario) | 機率分界 (Percentile) | 預期回報率 (ROI) |
| :--- | :--- | :--- |
| **樂觀情景 (Optimistic)** | Top 25% (Q3) | > **668.29%** |
| **基準情景 (Baseline)** | Median (Q2) | **7.19%** |
| **悲觀情景 (Pessimistic)** | Bottom 25% (Q1) | < **-63.41%** |
...
| :--- | :--- | :--- |
| **標準策略 (基於平均值)** | `47.56%` | `23.78%` |
| **穩健策略 (基於中位數)** | `46.04%` | `23.02%` |
| **保守策略 (基於保守預期)** | `36.16%` | `18.08%` |
| **激進策略 (基於樂觀預期)** | `49.26%` | `(不建議)` |
