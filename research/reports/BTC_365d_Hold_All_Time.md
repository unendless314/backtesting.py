...
**數據來源**: `BTCUSDT_1d.csv`
**完整數據範圍**: 2017-09-01 至 2026-09-09
**分析進場區間**: 2017-09-01 至 2025-09-09

## 統計概覽 (Statistics Overview)
| 指標 | 數值 | 說明 |
| :--- | :--- | :--- |
| **總交易樣本數** | 2931 天 | 模擬在此區間內每天買入 |
| **勝率 (Win Rate)** | **64.65%** (1895 天) | 持有 365 天後獲利的機率 |
| **賠率 (Loss Rate)** | 35.35% (1036 天) | 持有 365 天後虧損的機率 |
...
| :--- | :--- | :--- |
| **標準策略 (基於平均值)** | `55.23%` | `27.61%` |
| **穩健策略 (基於中位數)** | `51.31%` | `25.66%` |
| **保守策略 (基於保守預期)** | `22.15%` | `11.08%` |
| **激進策略 (基於樂觀預期)** | `60.29%` | `(不建議)` |
