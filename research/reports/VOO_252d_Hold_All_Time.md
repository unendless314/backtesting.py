...
**數據來源**: `VOO_1d.csv`
**完整數據範圍**: 2010-09-09 至 2026-01-21
**分析進場區間**: 2010-09-09 至 2025-01-17

## 統計概覽 (Statistics Overview)
| 指標 | 數值 | 說明 |
| :--- | :--- | :--- |
| **總交易樣本數** | 3613 天 | 模擬在此區間內每天買入 |
| **勝率 (Win Rate)** | **85.16%** (3077 天) | 持有 252 天後獲利的機率 |
| **賠率 (Loss Rate)** | 14.84% (536 天) | 持有 252 天後虧損的機率 |
...
| :--- | :--- | :--- |
| **整體回報率** | 12.52% | **13.62%** |
| **獲利交易平均回報** | +15.92% | +14.99% |
| **虧損交易平均回報** | -7.02% | -6.10% |
| **盈虧比 (Reward/Risk)** | **2.27** | **2.46** |

## 情景分析 (Scenario Analysis - Based on Quartiles)
| 情景 (Scenario) | 機率分界 (Percentile) | 預期回報率 (ROI) |
| :--- | :--- | :--- |
| **樂觀情景 (Optimistic)** | Top 25% (Q3) | > **19.44%** |
| **基準情景 (Baseline)** | Median (Q2) | **13.62%** |
| **悲觀情景 (Pessimistic)** | Bottom 25% (Q1) | < **4.29%** |
...
| :--- | :--- | :--- |
| **標準策略 (基於平均值)** | `78.63%` | `39.31%` |
| **穩健策略 (基於中位數)** | `79.12%` | `39.56%` |
| **保守策略 (基於保守預期)** | `68.08%` | `34.04%` |
| **激進策略 (基於樂觀預期)** | `83.62%` | `(不建議)` |
