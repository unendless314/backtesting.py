...
**完整數據範圍**: 2020-10-15 至 2026-09-09
**分析進場區間**: 2020-10-15 至 2025-09-09

## 統計概覽 (Statistics Overview)
| 指標 | 數值 | 說明 |
| :--- | :--- | :--- |
| **總交易樣本數** | 1791 天 | 模擬在此區間內每天買入 |
| **勝率 (Win Rate)** | **47.79%** (856 天) | 持有 365 天後獲利的機率 |
| **賠率 (Loss Rate)** | 52.21% (935 天) | 持有 365 天後虧損的機率 |
...
| **虧損交易平均回報** | -53.25% | -56.68% |
| **盈虧比 (Reward/Risk)** | **2.38** | **1.53** |

## 情景分析 (Scenario Analysis - Based on Quartiles)
| 情景 (Scenario) | 機率分界 (Percentile) | 預期回報率 (ROI) |
| :--- | :--- | :--- |
| **樂觀情景 (Optimistic)** | Top 25% (Q3) | > **81.59%** |
| **基準情景 (Baseline)** | Median (Q2) | **-11.04%** |
| **悲觀情景 (Pessimistic)** | Bottom 25% (Q1) | < **-58.68%** |
...
| :--- | :--- | :--- |
| **標準策略 (基於平均值)** | `25.83%` | `12.92%` |
| **穩健策略 (基於中位數)** | `13.69%` | `6.84%` |
| **保守策略 (基於保守預期)** | `-28.62%` | `-14.31%` |
| **激進策略 (基於樂觀預期)** | `35.13%` | `(不建議)` |
