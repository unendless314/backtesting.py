...
# Import from ETH-specific dashboard
import eth_dca_dashboard_mvp as dca
...
def create_heatmap(
    ...
    output_file(output_html, title='ETH DCA Parameter Analysis')
...
def main() -> None:
    ...
    output_html = RESULTS_DIR / f'eth_dca_param_analysis_{datetime.now():%Y%m%d_%H%M%S}.html'
