...
OUTPUT_HTML = RESULTS_DIR / 'dca_mvp_dashboard_zh.html'


def render_dashboard_cn(close: pd.Series, data_map, metrics_map, intervals) -> None:
...
def main() -> None:
    ...
    render_dashboard_cn(close, data_map, metrics_map, intervals)
