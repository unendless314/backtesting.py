"""BTC ATH-to-ATH intervals with drawdown segment visualization.

Run inside the repo's virtualenv:
    source .venv/bin/activate
    python playground/btc_peak_drawdown_ui_1d.py --help
"""
...
DEFAULT_DATA = Path('data/raw/BTCUSDT_1d.csv')
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='Visualize consecutive ATH gaps and drawdown segments.',
    ...
    parser.add_argument('--title', type=str, default='BTC/USDT Peak Gap + Drawdown',
...
def main() -> None:
    ...
    if interval_targets:
        ...
        for label, row in interval_targets:
            ...
            outfile = RESULTS_DIR / f"btc_peak_gap_dd_{suffix}_{batch_tag}.html"
            output_file(outfile)
            save(layout)
    ...
    outfile = RESULTS_DIR / f'btc_peak_gap_dd_{timestamp}.html'
    output_file(outfile)
    save(layout)
